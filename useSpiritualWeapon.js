...
SyncUrl=https://raw.githubusercontent.com/matthewbstroud/foundry_scripts/main/useSpiritualWeapon.js
*/
...
debugger;
if (!targetActor || (targetActor.data.type == "npc" && !targetActor.name.includes("Spiritual Weapon"))) {
