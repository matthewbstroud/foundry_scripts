    ...
    buttons: {
        yes: {
            ...
            callback: (html) => {
                ...
                let min_activation = toNumber(html.find('#min_activation').val());
                let max_activation = toNumber(html.find('#max_activation').val());

                updateLights(search_color, search_animation, new_color, new_animation, min_activation, max_activation);
            }
        },
        no: {
